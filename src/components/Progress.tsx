...
const Indeterminate = styled.div`
  ...
  &:before {
      -webkit-animation: ${webkitIndeterminate} 2.1s cubic-bezier(0.65, 0.815, 0.735, 0.395) infinite;
      animation: ${indeterminate} 2.1s cubic-bezier(0.65, 0.815, 0.735, 0.395) infinite;
  }

  &:after {
      -webkit-animation: ${webkitIndeterminateShort} 2.1s cubic-bezier(0.165, 0.84, 0.44, 1) infinite;
